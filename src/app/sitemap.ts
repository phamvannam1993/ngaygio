...
export default function sitemap({ id }: { id: string }): MetadataRoute.Sitemap {
  ...
  if (id === "tools") {
    ...
    return [
      ...
      u("/xem-tuoi-hop", now, "weekly", 0.84),
      u("/xem-tuoi-hop-lam-an", now, "weekly", 0.84),
      u("/xem-tuoi-vo-chong", now, "weekly", 0.84),
      u("/xem-tuoi-sinh-con", now, "weekly", 0.82),
      u("/xem-tuoi-lam-nha", now, "weekly", 0.84),
      u("/xem-tuoi-hop-mau-gi", now, "weekly", 0.80),
      u("/xem-tuoi-hop-huong-nao", now, "weekly", 0.80),
      u("/phong-thuy-theo-tuoi", now, "weekly", 0.80),
