  ...
  return (
    <section className="calendarCard" aria-labelledby="month-calendar-title">
      <div className="calendarHeader">
        <Link className="monthNav" href={navHrefFor(calendar.prevMonthDate)} aria-label="Tháng trước">←</Link>
        <div>
          <p className="eyebrow">Lịch tháng</p>
          <h2 id="month-calendar-title">{calendar.title}</h2>
        </div>
        <Link className="monthNav" href={navHrefFor(calendar.nextMonthDate)} aria-label="Tháng sau">→</Link>
      </div>
